...
package com.ipbox.actionbarcompat;
...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	protected SimpleMenuItem _homeItem;
	...
	private void setupActionBar() {
		...
		_homeItem = new SimpleMenuItem(
			tempMenu, android.R.id.home, 0, mActivity.getString(R.string.app_name));
		getHomeItem().setIcon(R.drawable.ic_home);
		addActionItemCompatFromMenuItem(getHomeItem());
	 ...
	 * {@link com.ipbox.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
	 */
	...
	public SimpleMenuItem getHomeItem() {
		return _homeItem;
	}
